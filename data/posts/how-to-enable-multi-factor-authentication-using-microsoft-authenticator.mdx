...
pubDate: "Oct 06 2024"
heroImage: "https://ik.imagekit.io/quadrate/assets/img/dotnetevangelist/MultiFactorAuthentication.jpg?updatedAt=1746813307808"
category: "O365"
...
<div className="flex flex-col md:flex-row gap-4 justify-center my-6">
  <div className="flex flex-col items-center">
    <Image src="https://ik.imagekit.io/quadrate/assets/img/dotnetevangelist/authenticator-ios-app.png?updatedAt=1746745493078" alt="Microsoft Authenticator app on iOS screenshot" width={300} height={600} className="max-w-xs rounded-lg shadow-md" />
    <p className="text-center mt-2 text-sm">Microsoft Authenticator on iOS</p>
  </div>
  <div className="flex flex-col items-center">
    <Image src="https://ik.imagekit.io/quadrate/assets/img/dotnetevangelist/authenticator-android-app.jpg?updatedAt=1746745493024" alt="Microsoft Authenticator app on Android screenshot" width={300} height={600} className="max-w-xs rounded-lg shadow-md" />
