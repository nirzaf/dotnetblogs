...
date: '2023-07-20'
description: 'Learn how to implement secure authorization between an Angular 18 frontend and a .NET Core API backend using JWT tokens and role-based access control.'
heroImage: 'https://ik.imagekit.io/quadrate/assets/img/dotnetevangelist/Angular_18_and_NET_Core_API_Authorization.jpg?updatedAt=1746813313487'
